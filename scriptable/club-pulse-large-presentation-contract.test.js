...
check('Launcher pins Large Presentation v2 to an immutable commit',/const LARGE_PRESENTATION_PATCH='https:\/\/raw\.githubusercontent\.com\/48wr9f4wgp-lab\/club-pulse\/[0-9a-f]{40}\/scriptable\/club-pulse-large-presentation-patch\.js';/.test(launcher));
check('Launcher uses Large Presentation v2 local cache',launcher.includes('ClubPulseLargePresentationPatch_v2.js')&&launcher.includes("'large-presentation2'"));
